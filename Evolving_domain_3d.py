...
def run_simulation():
    ...
    # Output file
    file1 = XDMFFile(MPI.COMM_WORLD, "Schnakenberg3D/outputu1.xdmf", "w")
    file1.write_mesh(msh)
    file2 = XDMFFile(MPI.COMM_WORLD, "Schnakenberg3D/outputu2.xdmf", "w")
